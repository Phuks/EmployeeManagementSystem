...
namespace EmployeeManagementSystem.Data.Migrations
{
    ...
    [Migration("20201118145509_RemovedItemsForNewTableSurveyAndAdjustedEmpWages")]
    partial class RemovedItemsForNewTableSurveyAndAdjustedEmpWages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeManagementSystem.Data.EmployeeHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("YearsCurrentRole")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagementSystem.Data.EmployeeJobInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("EmployeesJobInformation");
                });

            modelBuilder.Entity("EmployeeManagementSystem.Data.EmployeeWages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("EmployeeJobInfoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagementSystem.Data.EmployeeHistory", b =>
                {
                    b.HasOne("EmployeeManagementSystem.Data.Employee", "RequestingEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagementSystem.Data.EmployeeWages", b =>
                {
                    b.HasOne("EmployeeManagementSystem.Data.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("EmployeeManagementSystem.Data.EmployeeJobInfo", "EmployeeJobInfo")
                        .WithMany()
